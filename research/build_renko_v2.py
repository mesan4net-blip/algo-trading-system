...
if show_diag and barstate.islast
    dg := table.new(position.bottom_right, 3, 14, border_width=1,
         frame_color=color.new(#000000, 40), frame_width=1)
    ...
    _lbl  = array.from("Feed bars this bar", "Brick size", "Grid anchored", "Renko direction", "Bricks in a row", "Swing already traded", "In date range", "Re-entry push", "Order size", "Position", "Bricks formed", "Renko flips", "Trades")
    _val  = array.from(
